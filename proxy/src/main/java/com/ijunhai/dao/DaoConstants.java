...
public class DaoConstants {
    ...
    public final static String GP_DRIVER = "com.mysql.cj.jdbc.Driver";
    public final static String GP_URL = "gp.url";
    public final static String GP_USER = "gp.user";
    public final static String GP_PASSWORD = "gp.password";
